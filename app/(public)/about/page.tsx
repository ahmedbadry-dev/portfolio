    ...
    <div className="py-32">
      ...
      <Container>
        <div className="mx-auto max-w-[900px] space-y-32">
          ...
          <section id="mindset" className="space-y-5">
            <Reveal>
              <h2 className="text-2xl font-semibold tracking-tight">
                Discipline & Mindset
              </h2>
            ...
            <Reveal delay={0.05}>
              <p className="max-w-[720px] leading-8 text-muted-foreground">
                I optimize for <span className="font-medium text-foreground">long-term system integrity</span>. That means explicit boundaries, clear rendering contracts, and implementation decisions that scale with product complexity. The goal is not temporary velocity. The goal is <span className="font-medium text-foreground">sustainable engineering quality</span> under real constraints.
              </p>
            </Reveal>
          </section>
